...
const ApplicantSchema = new mongoose_1.Schema({
    ...
    userId: { type: mongoose_1.default.Schema.Types.ObjectId, ref: 'User', required: false }, // Optional - set when recruiter applies
    name: { type: String, required: true },
    email: { type: String, required: true },
    phone: { type: String },
    resumeText: { type: String, required: true },
    skills: { type: [String], default: [] },
    experience: { type: [mongoose_1.Schema.Types.Mixed], default: [] },
    education: { type: [mongoose_1.Schema.Types.Mixed], default: [] },
