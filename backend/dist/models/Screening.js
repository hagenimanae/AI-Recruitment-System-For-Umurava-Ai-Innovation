...
const ScreeningSchema = new mongoose_1.Schema({
    ...
    applicantId: { type: mongoose_1.default.Schema.Types.ObjectId, ref: 'Applicant', required: true },
...
exports.default = mongoose_1.default.models.Screening || mongoose_1.default.model('Screening', ScreeningSchema);
